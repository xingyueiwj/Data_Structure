...
public class DijkstraTest {
    ...
    public static void main(String[]args){
        ...
        RowColWeight[]rcw = {new RowColWeight(0,2,5),
                new RowColWeight(0,3,30),
                new RowColWeight(1,0,2),
                new RowColWeight(1,4,8),
                new RowColWeight(2,1,15),
                new RowColWeight(2,5,7),
                new RowColWeight(4,3,4),
                new RowColWeight(5,3,10),
        ...
        try {
            ...
            System.out.println("从顶点A到其他各项顶点的最短距离为:");
            for (int i =1;i<n;i++){
                System.out.println("到顶点"+g.getValue(i)+"的最短距离为"+distance[i]);
            }
            System.out.println("从顶点A到其他各项顶点的前一项顶点分别为:");
            for (int i = 0;i<n;i++){
                if (path[i]!=-1){
